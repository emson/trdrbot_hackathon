...
export const resources = [
	...
	},
	{
		...
		description:
			'The whole system, explained from the top down. Click any stage of the Sense → Think → Act → Learn loop to open it — plus the shared Remember layer every stage reads and writes — step through one real trade end to end — the actual thesis, strikes and exit rules — then find every one of the ~45 modules by name.',
		kind: 'interactive',
		icon: 'automate',
